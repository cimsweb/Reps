...
Детальный чеклист — в [tasks/mvp-0.md](tasks/mvp-0.md). Текущая разработка — **MVP 1** ([tasks/mvp-1.md](tasks/mvp-1.md)). Общие правила — в [AGENT.md](AGENT.md).

API: [аутентификация](docs/api/auth.md) · [coaching MVP 1](docs/api/coaching.md) · [схема БД coaching](docs/db/coaching-schema.md)
...
- **Тренер** (`/coach`): отправка приглашения, список приглашений со статусами, список связанных спортсменов, карточка `/coach/athletes/{id}` (профиль, рекорды, feedback с Garmin).
